...
- [#18](https://github.com/Saeris/configs/pull/18)  *(patch)* Thanks [@Saeris](https://github.com/Saeris)! - Fix consumer overrides being unable to disable or relax `vitest/*` rules.
...
- [#16](https://github.com/Saeris/configs/pull/16)  *(minor)* Thanks [@Saeris](https://github.com/Saeris)! - Relax `vitest/no-conditional-in-test` and `vitest/no-conditional-expect` from
